...
const SymbolEnd Symbol = core.SymbolEnd
...
// MarkEndCalled reports whether MarkEnd has been called in the current lex pass.
func (l *Lexer) MarkEndCalled() bool {
	return l.markEndCalled
}
