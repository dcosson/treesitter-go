...
**Matches C's ts_parser\_\_recover well**:
...
**Matches C's ts_parser\_\_recover_to_state**:
...
**Matches C's ts_parser\_\_better_version_exists**:
...
**Matches C's ts_parser\_\_shift**: Simple, correct.

### 1.9 doAccept (parser.go:834-855)

**Matches C's ts_parser\_\_accept**:
