...
.PHONY: build test bench fetch-test-grammars fetch-corpora test-corpus test-corpus-json test-regression test-corpora-diff deps diff-test generate-scanner-traces test-scanner-traces
